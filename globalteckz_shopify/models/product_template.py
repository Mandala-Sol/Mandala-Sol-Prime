            ...
            if str(options['name']) != 'Title':
                ...
                if 'name' in options:
                    ...
                    if att_id:
                        ...
                        attribute_id = product_attribute_obj.create({'name': att_name.lower(),'create_variant': True}).id
        ...
        if 'variants' in products and len(products['variants']) > 1:
            ...
            for variant in products['variants']:
                ...
                if 'option1' in variant and variant['option1'] != None and variant['option1'] != 'Default Title':
                    #print ("variant['option1']+++++++",variant['option1'])
...
#                    print ("variant['option2']++++",variant['option2'])
#                    print ("value_id2+++++++++++++",value_id2)
                    #   print ("value11111111111encode",variant['option2'][:128].encode('utf-8').strip(" "))
                ...
                #print ("product_product++++++++++++++1",product_product)
